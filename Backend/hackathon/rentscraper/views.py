...
import pandas as pd
from .models import RentalListing  # Import the RentalListing model
...
async def scrape_killamreit():
    ...
    async with async_playwright() as playwright:
        ...
        final_details_df = pd.DataFrame(final_details)
        final_details_df.to_csv('properties.csv', index=False)
        logger.info("Exported final details to properties.csv")
